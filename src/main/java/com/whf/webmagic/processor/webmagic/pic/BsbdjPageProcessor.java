 ...
 */
@Component
public class BsbdjPageProcessor implements PageProcessor {
    ...
    public BsbdjPageProcessor(){};

    public BsbdjPageProcessor(DelightWebmagicDao delightWebmagicDao){
        this.delightWebmagicDao = delightWebmagicDao;
    }

    private BsbdjPageProcessor(Site site) {
        this.site = site;
    }
...
//        Spider.create(new TestPageProcessor()).addUrl("http://www.budejie.com").thread(5).run();
    ...
    {
        Spider.create(new BsbdjPageProcessor(delightWebmagicDao)).addUrl("http://www.budejie.com").thread(5).run();
    }
}
