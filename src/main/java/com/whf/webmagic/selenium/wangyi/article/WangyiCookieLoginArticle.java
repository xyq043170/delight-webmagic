package com.whf.webmagic.selenium.wangyi.article;
 ...
 */
@Component
public class WangyiCookieLoginArticle {
    private final static Logger LOG = LoggerFactory.getLogger(WangyiCookieLoginArticle.class);
    ...
    public WangyiCookieLoginArticle(DelightWebmagicDao delightWebmagicDao, DelightArticleDao delightArticleDao){
    ...
    public static void main(String[] args) {
        WangyiCookieLoginArticle aa=new WangyiCookieLoginArticle(null,null);
        aa.crawl();
    }
    ...
    public void crawl(){
        driver = new ChromeDriver();
            try {
                ...
                driver.get(ConstantKey.WANGYI_LOGIN_URL);
                Thread.sleep(3 * 1000);
                File cookieFile = new File(ConstantKey.WANGYI_COOKIE_PATH);
                ...
                while ((line = bufferedReader.readLine()) != null){
                    ...
                    while (stringTokenizer.hasMoreTokens()){
                        ...
                        LOG.info("crawl name="+name);
                        LOG.info("crawl value="+value);
                        LOG.info("crawl domain="+domain);
                        LOG.info("crawl path="+path);
                        LOG.info("crawl expiry="+expiry);
                        LOG.info("crawl isSecure="+isSecure);
                        Cookie cookie = new Cookie(name, value,domain,path,expiry,isSecure);
                        driver.manage().addCookie(cookie);
                    }
                }
                Thread.sleep(60 * 1000);
                LOG.info("crawl open main url");
                //打开主页
                driver.get(ConstantKey.WANGYI_MAIN_URL);
    ...
    {
        LOG.info("Start wangyi cookieLogin task");
        new WangyiCookieLoginArticle(delightWebmagicDao,delightArticleDao).crawl();
    }
}
