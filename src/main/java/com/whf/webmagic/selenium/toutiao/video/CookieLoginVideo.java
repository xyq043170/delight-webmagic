package com.whf.webmagic.selenium.toutiao.video;
 ...
 */
@Component
public class CookieLoginVideo {
    private final static Logger LOG = LoggerFactory.getLogger(CookieLoginVideo.class);
    ...
    public CookieLoginVideo(DelightWebmagicDao delightWebmagicDao, DelightArticleDao delightArticleDao,DelightVideoResultDao delightVideoResultDao){
...
//        Thread.sleep(2000);
    ...
    public static void task(DelightWebmagicDao delightWebmagicDao, DelightArticleDao delightArticleDao,DelightVideoResultDao delightVideoResultDao)
    {
        ...
        new CookieLoginVideo(delightWebmagicDao,delightArticleDao,delightVideoResultDao).crawl();
    }
}
